...
<div class="wrap">
	...
	if(($actionID=='explode'||$actionID=='explodejd' )and $controllerID=='jianguo'){
    ?>
    ...
    <div class="row">
		...
		<div class="col-lg-2" style="padding:80px 10px 60px 40px;">
		<?php
		$_sidebar = '..\jianguo\_sidebar';
         echo $this->render ($_sidebar);
		?>
		</div>
		<div class="col-lg-10" style="padding:80px 0px 60px 100px;" >
        <?= $content ?>
		</div>
